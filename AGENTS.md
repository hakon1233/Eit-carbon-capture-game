...
<!-- BEGIN:template-skills (auto-generated by bootstrap-claude-template.sh — do not edit between markers) -->

## Template skills (auto-generated)

Every skill below ships with this repo template. Claude Code auto-loads each one when its description matches the prompt context. Codex and other agents: read the SKILL.md file when your task matches the trigger below.
...
_Regenerated on every `bootstrap-claude-template.sh` run. Any edits between the BEGIN/END markers will be overwritten. Customizations belong outside this block._
