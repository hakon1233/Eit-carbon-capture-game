...
// Difficulty modes configuration — imported from the shared single source
// of truth (public/modules/data/difficulty-modes.js, CAR-163) so the launch
// screen and the simulation stay in lockstep. See import at top of file.
